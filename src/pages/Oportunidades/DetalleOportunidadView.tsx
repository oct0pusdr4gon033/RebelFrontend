...
const ESTADO_CONFIG: Record<string, { color: string; bg: string; icon: string }> = {
  ...
  'OC_RECIBIDA':   { color: '#0284c7', bg: '#e0f2fe', icon: 'receipt_long' },
  'OC_ACEPTADA':   { color: '#059669', bg: '#d1fae5', icon: 'thumb_up' },
  'OC_RECHAZADA':  { color: '#dc2626', bg: '#fee2e2', icon: 'thumb_down' },
  'ENTREGADA':     { color: '#7c3aed', bg: '#ede9fe', icon: 'inventory' },
};
